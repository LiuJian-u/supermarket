...
<head>
    ...
    <title>admin_purchase_management</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a class="subMenuItem" href="#">进货单管理</a></li>
                        <li><a class="subMenuItem" href="#">进货统计管理</a></li>
                        <li><a class="subMenuItem" href="#">进货退货统计管理</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <div class="ItemBlock">
        <div class="col-md-2 left-nav-block">
            <ul class="nav nav-pills nav-stacked">
                <li><a href="#" class="nav-left">进货单查询</a></li>
                <li><a href="#" class="nav-left">进货记录查询</a></li>
                <li><a href="#" class="nav-left">进货退货记录查询</a></li>
            </ul>
        </div>
        <%--        todo：进货单查询--%>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="col-md-4">
                            <label class="input-group">
                                ...
                                <input name="s_name" type="text" class="form-control" placeholder=""
                                       aria-describedby="basic-addon2-2">
                            </label>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="btn query-btn">查询</button>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="col-md-4">
                            <label class="input-group">
                                ...
                                <input name="s_name" type="text" class="form-control" placeholder=""
                                       aria-describedby="basic-addon3-2">
                            </label>
                        </div>
                        <div class="col-md-4">
                            <button type="submit" class="btn query-btn">查询</button>
