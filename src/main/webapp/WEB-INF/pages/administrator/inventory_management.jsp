...
<head>
    ...
    <title>admin_inventory_management</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li><a class="subMenuItem" href="#">入库</a></li>
                        <li><a class="subMenuItem" href="#">出库</a></li>
                        <li><a class="subMenuItem" href="#">库存</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div class="container-fluid">
        ...
        <div class="ItemBlock">
            <div class="col-md-2 left-nav-block">
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="#" class="nav-left">入库信息查询</a></li>
                </ul>
            </div>
            <%--        todo：入库信息查询--%>
    ...
    <div class="ItemBlock">
        ...
        <div class="ItemBlock">
            <div class="col-md-2 left-nav-block">
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="#" class="nav-left">出库信息查询</a></li>
                </ul>
            </div>
            <%--        todo：销售单查询--%>
            <div class="col-md-10 panel-of-nav-left">
    ...
    <div class="ItemBlock">
        ...
        <div class="ItemBlock">
            <div class="col-md-2 left-nav-block">
                <ul class="nav nav-pills nav-stacked">
                    <li><a href="#" class="nav-left">库存查询</a></li>
